    ...
    <div className="card bg-[#15263F] w-80 h-auto rounded-xl p-6 space-y-4">
      ...
      <div id="description" className="space-y-4">
        ...
        <div className="flex text-sm justify-end text-white">
          <button className="p-2 rounded-xl w-full border border-transparent hover:border-cyan-500 bg-transparent font-bold text-md text-white hover:text-cyan-300 hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0">
            Vote
          </button>
        </div>
      </div>
