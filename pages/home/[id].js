  ...
  return (
    <div className="w-full bg-secondary">
      ...
      <div className="px-10 pt-4 flex items-center justify-between w-full">
        <h1 className="text-Poppins font-semibold text-2xl">Name of Ballot</h1>
        {!voting && (
      ...
      <hr className="mt-6 mx-10 border bg-white rounded-sm border-white" />
      <div className="p-10 py-8 grid grid-flow-row-dense grid-cols-1 md:grid-cols-4">
        <p className="mt-2 text-lg text-Montserrat col-span-1 md:col-span-3">
          ...
          fugiat accusamus. Porro ut numquam saepe cupiditate quae odio facilis
          quo iure dolores, illo voluptate aperiam. Dolorum, repudiandae
          distinctio rem esse, unde tenetur quas impedit voluptatibus nihil amet
          labore. Ex ea accusantium saepe veniam voluptates dolorem, voluptate
          blanditiis explicabo eaque eum autem id necessitatibus expedita
          ducimus architecto omnis eius animi facere cum soluta ipsa
          dignissimos. Consequatur blanditiis ab error iusto explicabo illum
          modi sunt recusandae corrupti nam esse, porro aperiam doloremque velit
          cumque veritatis!
        </p>
        <img
